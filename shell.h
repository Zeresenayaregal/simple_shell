...
int envir(char *s, char **arg_vec, char *fl, char **env, int ct, int out);

int search_command(char **argv, char *file, char **environ, int ct);
int divpath(char **argv, char *file, char **environ, int ct);
...
void printerror(char *file, char *argv, int ct, char *message);
void printnumber(int number);
void printerrorex(char *file, char **argv, int ct, char *message);
